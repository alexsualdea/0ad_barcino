...
//const heightfile = "mediterranean.png";
const heightfile = "gulf1.png";
...
print("***BIOME: " + g_MapSettings.Biome);

var selectedBiome = g_MapSettings.Biome;
...
g_Map.LoadHeightmapImage(heightfile, 0, 40);
...
//initTileClasses(["autumn", "desert", "temperate", "snowy", "alpine", "mediterranean", "tropic"]);
...
var northernTopLeft = new Vector2D(fractionToTiles(0), fractionToTiles(0));
var westernTopLeft = new Vector2D(fractionToTiles(0), fractionToTiles(0));
var africaTop = fractionToTiles(0);
