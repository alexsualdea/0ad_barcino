...
const heightfile = "hiberusflumen.png";
const normalMinHeight = -1; // set to 0 to have water
const normalMaxHeight = 50; // like a height 'multiplier'. more bigger, more mountains
