...
const heightfile = "gibraltar.png";
const normalMinHeight = 0; // set to 0 to have water
const normalMaxHeight = 40; // like a height 'multiplier'. more bigger, more mountains
...
initTileClasses(["shoreline", "mapTile", "island"]);
...
if (!isNomad())
{
	...
	if (teamsArray.length == 2)
	{
		...
		const [playerIDs, playerPosition] = createBasesByPattern(
			"stronghold", 
			fractionToTiles(randFloat(0.35, 0.35)), 
	...
	{
		print("Teams != 2, random player placement");
