function CalculateTraderGain(firstMarket, secondMarket, traderTemplate, trader)
{
	...
	// AQUI: calculates new trading gain for unbalanced teams
	let marketsGainTeamProportion = global.barcino.getTradingProportionModifierForMarkets(firstMarket, secondMarket);
	gain.traderGain = Math.round(gain.traderGain * marketsGainTeamProportion * 10) / 10; // 1 decimal for nearby markets
